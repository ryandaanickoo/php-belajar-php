...
<body>
    <nav>
        ...
        <ul id="menu">
            ...
            <li><a href="assets/navigasi/produk.html">PRODUK</a></li>
            <li><a href="assets/navigasi/galeri.html">GALERI</a></li>
            <li><a href="assets/navigasi/berita.html">BERITA</a></li>
            <li><a href="assets/navigasi/biodata.html">TENTANG SAYA</a></li>
        </ul>
    </nav>
    <section id="box-profile">
        <div class="img-profile">
            <div class="photo" style="background-image:
        url(assets/img/ryanganteng.jpg)"></div>
        </div>
        <div>
            <div class="description">
                ...
                <a href="assets/navigasi/kontak.html" class="button border-blue">Contact</a>
            </div>
